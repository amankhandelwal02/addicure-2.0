      ...
      <Portal>
        <SafeAreaView style={styles.container}>
          ...
          <View className="-z-10">
            ...
            >
              <Text style={styles.heading_text}>Recommended Diet</Text>
              <ScrollView
                horizontal
              ...
              <View className="">
                <Text style={styles.feature_main_container}>Main Features</Text>
              ...
              <View className="">
                <Text style={styles.other_features_text}>Other Features</Text>
                <View style={styles.category_card_container}>
          ...
          actions={[
            {
              icon: "plus",
              label: "Start Over",
              onPress: () => navigation.navigate("FirstQuestionnaire"),
            },
            {
              icon: "bell",
